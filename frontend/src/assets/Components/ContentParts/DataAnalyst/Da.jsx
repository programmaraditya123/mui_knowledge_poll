...
const Da = () => {
  ...
  const [searchtitle, setSearchTitle] = useState(title === "" || title === undefined ? "Data Collection" : title);
...
const data_analyst_topics = [
  ...
  const getContent = async () => {
    ...
    try {
      const data = await axios.get(`${BASE_URL}/app/getcont/getdacontent`, { params: { title: searchtitle } });
    ...
    <Suspense fallback={<div>Loading ...</div>}>
      ...
      <div className='disp-cont'>
        ...
        <div className='disp-cont-2'>
          ...
          <button className='btn-18' onClick={() => routerchange(searchtitle,16)}>Write Content</button> : <button className='btn-18' onClick={() => routerchange1(searchtitle,cont,16)}>Modify Content</button>
          }
